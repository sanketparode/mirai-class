...
const Hero = () => {
  return (
    <section className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-8 leading-relaxed max-w-3xl animate-fade-in">
            ...
            clarity, and success in Science and Mathematics.
          </p>
